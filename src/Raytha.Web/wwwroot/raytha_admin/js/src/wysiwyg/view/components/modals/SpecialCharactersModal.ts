...
import specialCharactersModalTemplate from "wysiwyg/view/components/modals/templates/specialCharactersModal.html";

export class SpecialCharactersModal extends ModalBaseComponent {
   private characters: Record<string, { char: string, title: string }[]> = {
      'currency': [
   ...
   protected render(): HTMLElement {
      return this.createElementFromTemplate(specialCharactersModalTemplate);
   }
            ...
            if (container) {
               container.innerHTML = values.map(({ char, title }) => `
                <button type="button" 
                  ...
                  data-tiptap--tiptap-character-param="${char}"
